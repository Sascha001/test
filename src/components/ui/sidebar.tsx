...
export const SIDEBAR_WIDTH = "11.25rem"
      ...
      return (
        ...
        >
          ...
          <div
            ref={ref}
            className={cn(
              "fixed inset-y-0 z-10 h-full w-[--sidebar-width-mobile] bg-sidebar p-6 text-sidebar-foreground shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left data-[state=open]:duration-300 data-[state=closed]:duration-300",
              side === "left" ? "left-0" : "right-0",
              openMobile ? "data-[state=open]" : "data-[state=closed]"
            )}
          >
            {children}
          </div>
      ...
      >
        ...
        <div
          className={cn(
            ...
            "group-data-[state=collapsed][data-collapsible=icon]:w-[--sidebar-width-icon] group-data-[side=left]:border-r group-data-[side=right]:border-l",
            variant === "floating"
